...
//             const dataTimeDisplayLi = document.createElement("div");
//             dataTimeDisplayLi.classList.add("dateTimeDisplay");
...
//             newList.appendChild(dataTimeDisplayLi);
//             listContainer.appendChild(newList);
//             newList.appendChild(symbolText);
//             newList.appendChild(chackBtn);
//             newList.appendChild(deliteBtn);
...
//     function deleteList(item) {
//         item.remove();
//         // After deleting, save the updated list to localStorage
//         saveListData();
//     }
...
//             item.classList.toggle("active");
//         }
//         // Update localStorage after toggling active state
//         saveListData();
//     }
...
//     function handleDrop(e) {
//         if (draggedItem !== e.target) {
//             const newPosition = Array.from(listContainer.children).indexOf(
//                 e.target
//             );
//             if (newPosition > -1) {
//                 listContainer.removeChild(draggedItem);
...
//                 );
//             }
//             // Update localStorage after dropping the item
//             saveListData();
//         }
//     }
...
//             e.target.contentEditable = false;
//             e.target.removeAttribute("data-editing");
//             // Update localStorage after editing the list item
//             saveListData();
//         }
//     });
...
//         const dateTimeDisplays = document.querySelectorAll(".dateTimeDisplay");
//         console.log((dateTimeDisplays.innerHTML = `${date} ${time}`));
//         dateTimeDisplays.forEach((dateTimeDisplay) => {
